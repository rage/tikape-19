...
Relaatiomallissa kukin käsitteeseen liittyvä attribuutti kuvaa kaikki mahdolliset arvot joita kyseinen attribuutti voi saada. Relaatiot ovat näistä attribuuteista muodostettuja joukkoja

nähdään arvojoukkona, ja relaatiot ovat näistä arvojoukoista muodostettuja monikkoja. Matemaattisesti relaatio voidaan määritellä joukkona

 attribuuttien  ovat näistä arvojoukoista koostuvia monikkoja

TODO: Relaatiomallin perusidea.

* Jokainen rivi on uniikki, eli tietokantataulu ei voi sisältää kahta täysin samanlaista riviä.


Ennen relaatiomallia tietokantoja ja tietoa kuvattiin muunmuassa <a href="https://en.wikipedia.org/wiki/Hierarchical_database_model" target="_blank">hierarkisen mallin</a> ja <a href="https://en.wikipedia.org/wiki/Network_model" target="_blank">verkkomallin</a> avulla. Molempia käytetään yhä, mutta relaatiomalliin perustuvat tietokannat ovat edellä mainittuja malleja suositumpia.
...
TODO: kuva, missä tietokannanhallintajärjestelmä sekä sovellus. Tietokannanhallintajärjestelmän sisällä on tietokantoja. Tietokannan sisällä on tietoa: useita tauluja. Tauluihin merkitty pää- ja viiteavaimet.
